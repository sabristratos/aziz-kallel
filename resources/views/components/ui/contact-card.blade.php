...
<div class="relative group p-3 sm:p-4 rounded-lg hover:bg-gray-50 transition-colors duration-200">
    ...
    @if($icon)
        <!-- Background Icon -->
        <div class="absolute -top-2 -left-2 w-20 h-20 text-golden-amber-500/8 -rotate-12 transition-all duration-300 ease-out group-hover:scale-110 group-hover:-rotate-[20deg] group-hover:text-golden-amber-500/12">
