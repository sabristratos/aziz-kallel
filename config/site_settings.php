...
return [
    ...
    [
        'key' => 'about_benefit_1_title',
        'value' => [
            'de' => 'Expertise & Erfahrung',
            'ar' => 'الخبرة والكفاءة المهنية',
        ],
        'type' => 'string',
    ],
    [
        'key' => 'about_benefit_1_description',
        'value' => [
            'de' => 'Über 15+ Jahre Erfahrung in der ganzheitlichen Finanzberatung. Ich begleite Sie kompetent auf dem Weg zu Ihrer finanziellen Sicherheit.',
            'ar' => 'أكثر من 15+ سنوات خبرة في مجال الاستشارات المالية الشاملة. أرافقك بكل احترافية في طريقك نحو الأمان المالي.',
        ],
        'type' => 'text',
    ],
    [
        'key' => 'about_benefit_2_title',
        'value' => [
            'de' => 'Vertrauen & Qualität',
            'ar' => 'الثقة والجودة العالية',
        ],
        'type' => 'string',
    ],
    [
        'key' => 'about_benefit_2_description',
        'value' => [
            'de' => 'Zertifizierter und geprüfter Finanzberater bei der Deutschen Vermögensberatung - Deutschlands größter eigenständiger Finanzberatung. Meine kontinuierliche Weiterbildung und strenge Qualitätsstandards garantieren Ihnen professionelle Beratung auf höchstem Niveau.',
            'ar' => 'مستشار مالي معتمد ومرخص لدى دويتشه فيرموغنسبيراتونغ - أكبر شركة استشارات مالية مستقلة في ألمانيا. تضمن لك شهاداتي المهنية المعترف بها وتدريبي المستمر ومعايير الجودة الصارمة التي ألتزم بها الحصول على استشارة احترافية على أعلى مستوى. ثقتك هي أهم أولوياتي، ولذلك أعمل دائماً بشفافية تامة ووفقاً لأعلى المعايير الأخلاقية.',
        ],
        'type' => 'text',
    ],
    [
        'key' => 'about_benefit_3_title',
        'value' => [
            'de' => 'Persönlich & Individuell',
            'ar' => 'شخصي ومخصص',
        ],
        'type' => 'string',
    ],
    [
        'key' => 'about_benefit_3_description',
        'value' => [
            'de' => 'Jeder Mensch ist einzigartig - und so sollte auch Ihre Finanzberatung sein. Ich nehme mir Zeit, Ihre persönliche Situation, Wünsche und Ziele genau zu verstehen und entwickle maßgeschneiderte Lösungen, die perfekt zu Ihrem Leben passen. Ihre Zufriedenheit steht für mich an erster Stelle.',
            'ar' => 'كل شخص فريد من نوعه - وكذلك يجب أن تكون استشارتك المالية. أخصص الوقت الكافي لفهم وضعك الشخصي ورغباتك وأهدافك بدقة، وأطور حلولاً مصممة خصيصاً لتتناسب تماماً مع حياتك واحتياجاتك الفردية. رضاك وثقتك تأتي في المقام الأول بالنسبة لي. سواء كنت في بداية مسيرتك المهنية، تخطط لتأسيس عائلة، أو تستعد للتقاعد - أنا هنا لدعمك في كل مرحلة من مراحل حياتك المالية.',
        ],
        'type' => 'text',
    ],
    [
        'key' => 'about_benefit_4_title',
        'value' => [
            'de' => 'Flexibel & Unkompliziert',
            'ar' => 'مرونة وسهولة في التعامل',
        ],
        'type' => 'string',
    ],
    [
        'key' => 'about_benefit_4_description',
        'value' => [
            'de' => 'Ihre Zeit ist wertvoll. Deshalb passe ich mich Ihrem Terminkalender an - ob morgens, abends oder am Wochenende. Wir treffen uns dort, wo es für Sie am bequemsten ist: bei Ihnen zu Hause, in Ihrem Büro oder in meinen Räumlichkeiten. Auch Online-Beratungen via Video-Call sind selbstverständlich möglich.',
            'ar' => 'وقتك ثمين. لذلك أتكيف مع جدولك الزمني - سواء في الصباح أو المساء أو في عطلة نهاية الأسبوع. نلتقي في المكان الأنسب لك: في منزلك، في مكتبك، أو في مكتبي. كما أن الاستشارات عبر الإنترنت من خلال مكالمات الفيديو متاحة أيضاً بكل سهولة. أتحدث معك باللغة العربية والألمانية لضمان فهم كامل وواضح لجميع الجوانب المالية، وأضمن لك سرية تامة لجميع معلوماتك الشخصية.',
        ],
        'type' => 'text',
    ],
